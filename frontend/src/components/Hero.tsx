  ...
  return (
    <div className="w-full min-h-[90vh] flex flex-col relative overflow-hidden bg-[#fafafa]">
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 pb-12">
        ...
        >
          {/* Decorative Labels */}
          <div className="absolute top-1/4 left-0 -translate-x-1/2 z-20 hidden lg:flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-widest rotate-90 origin-left">
            <div className="w-8 h-px bg-slate-300"></div>
            8 SOURCES
          </div>
          
          <div className="absolute bottom-1/4 right-0 translate-x-1/2 z-20 hidden lg:flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-widest -rotate-90 origin-right">
            8 AGENTS
            <div className="w-8 h-px bg-slate-300"></div>
          </div>
